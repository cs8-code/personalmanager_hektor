...
export default function SipoNewsPage() {
  const { user } = useAuth();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8 flex items-center justify-between">
          ...
          <button
            ...
            className="inline-flex items-center px-4 py-2 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold rounded-lg transition-colors"
          >
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-800 mt-1">
                  Community für Bauleiter - Teilen Sie Neuigkeiten und stellen Sie Fragen
                </p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleCreatePost} className="space-y-4">
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="px-4 py-2 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold rounded-lg disabled:opacity-50"
                >
            ...
            <div className="p-6 border-t border-gray-200">
              {user ? (
                <form onSubmit={handleAddComment} className="flex space-x-3">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold rounded-lg flex items-center"
                  >
                ...
                <div className="text-center py-4">
                  <p className="text-gray-600 mb-3">Melden Sie sich an, um zu kommentieren</p>
                  <button
                    onClick={() => setShowLoginModal(true)}
                    className="px-6 py-2 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold rounded-lg"
                  >
                    Anmelden
                  </button>
                </div>
